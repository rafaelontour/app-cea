...
fun HomeScreen(
    ...
    Column(modifier) {
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(10.dp)) {
            ...
            ShortcutCard("🔍", "Exercícios", Modifier.weight(1f), onExercises)
        }
        ...
        CeaCard {
            ...
            Text(
                "Mantenha a constância. A técnica correta nos exercícios previne lesões e maximiza seus resultados a longo prazo.",
